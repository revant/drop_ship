...
erpnext.accounts.DropShipInvoiceController = erpnext.selling.SellingController.extend({
	onload: function() {
		var me = this;
		this._super();
...
$.extend(cur_frm.cscript, new erpnext.accounts.DropShipInvoiceController({frm: cur_frm}));
