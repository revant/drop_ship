...
class DropShipInvoice(SellingController):
	def __init__(self, arg1, arg2=None):
		super(DropShipInvoice, self).__init__(arg1, arg2)
		self.status_updater = [{
	...
	def validate(self):
		#super(DropShipInvoice, self).validate()
	...
	def on_submit(self):
		super(DropShipInvoice, self).on_submit()
	...
	def set_missing_values(self, for_validate=False):
		...
		super(DropShipInvoice, self).set_missing_values(for_validate)
	...
	def get_advances(self):
		if not self.is_return:
			super(DropShipInvoice, self).get_advances(self.debit_to, "Customer", self.customer,
	...
	def validate_with_previous_doc(self):
		super(DropShipInvoice, self).validate_with_previous_doc({
			"Sales Order": {
	...
	def validate_warehouse(self):
		super(DropShipInvoice, self).validate_warehouse()
	...
	def make_item_gl_entries(self, gl_entries):
		...
		if cint(frappe.defaults.get_global_default("auto_accounting_for_stock")) \
			...
			gl_entries += super(DropShipInvoice, self).get_gl_entries()
